        ...
        <div className="flex flex-col flex-1 text-[#cdc69c]">
          <header>
            ...
            <motion.p
              ...
              variants={textReveal}
            >
              <span className="font-bold text-black" aria-hidden="true">&gt;</span> {t("sobremi.subtitle")}
            </motion.p>
          </header>
          ...
          >
            ...
            <p className="mt-4">
              <Trans
                i18nKey="sobremi.p2"
                components={{ c1: <strong />, c2: <strong /> }}
              >
                <strong />
                <strong />
              </Trans>
