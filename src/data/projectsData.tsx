...
export const PROJECTS: Proyecto[] = [
    ...
    },
    {
        ...
        pressingType: "First" as const,
        stats: ["Web + App Móvil", "Roles (admin/piloto/cliente)", "Row Level Security", "Zustand"],
    ...
    },
    {
        ...
        pressingType: 'Remaster',
        stats: ["Alta demanda real", "Mobile-first", "Uso en carretera"],
    ...
    },
    {
        ...
        stats: ["Health-checks / 60s", "Alertas email automáticas"],
